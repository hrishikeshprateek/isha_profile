                            ...
                            paginatedBlogs.map((blog) => (
                                ...
                                >
                                    ...
                                    <div className="md:col-span-2 flex items-center md:justify-end gap-2 mt-2 md:mt-0 border-t md:border-t-0 border-[#3B241A]/5 pt-4 md:pt-0">
                                        ...
                                        <button
                                            disabled
                                            className="flex-1 md:flex-none flex items-center justify-center gap-2 px-3 py-2 rounded-lg bg-gray-50 text-gray-400 text-xs font-bold cursor-not-allowed opacity-50"
                                        >
